...
class Descpritionstep2 extends StatefulWidget {
  Descpritionstep2({Key? key, this.title, required this.user})
      : super(key: key);
  ...
  @override
  _Descpritionstep2State createState() => _Descpritionstep2State();
}

class _Descpritionstep2State extends State<Descpritionstep2> {
  ...
  Widget _submitButton() {
    return InkWell(
      onTap: () async {
        ...
        await ref
            .update({
              'Location': age_ctrl.text,
              'Description': weight_ctrl.text + ' $dropdownvalue_weight'
            })
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      _entryField('Location', age_ctrl, 'Example : Ariana'),
                      SizedBox(
                        height: 5,
                      ),
                      _entryField(
                          'Tell us about yourself', weight_ctrl, 'I am ...'),
                      SizedBox(
                        height: 30,
                      ),
                      _submitButton(),
