...
import 'package:splign_p2m/Signup_login/Description_doctor_step2.dart';
import 'package:splign_p2m/Signup_login/Widget/bezierContainer.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter_spinkit/flutter_spinkit.dart';

class DesciprionDoctor extends StatefulWidget {
  DesciprionDoctor({Key? key, this.title, required this.user})
      : super(key: key);
  ...
  @override
  _DesciprionDoctorState createState() => _DesciprionDoctorState();
}

class _DesciprionDoctorState extends State<DesciprionDoctor> {
    ...
    return InkWell(
      onTap: () async {
        ...
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => Descpritionstep2(
                      user: widget.user,
                    )));
      },
      child: Container(
